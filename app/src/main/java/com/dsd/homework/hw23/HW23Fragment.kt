...
class HW23Fragment : Fragment() {
    ...
    private fun getUsers() = mutableListOf<UserWithImage>(
        UserWithImage(
            "Jhon",
            "Watson",
            30,
            "https://klike.net/uploads/posts/2018-07/1531820435_2.jpg"
        ),
        UserWithImage(
            "Mike",
            "Brown",
            30,
            "https://bipbap.ru/wp-content/uploads/2017/04/maxresdefault-1-9.jpg"
        ),
        UserWithImage(
            "Jack",
            "Warner",
            30,
            "https://i.pinimg.com/originals/4b/ba/6f/4bba6f4d487a8029817f63ff9101911d.jpg"
        ),
    )
